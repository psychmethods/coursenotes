...
try(include_tweet("https://twitter.com/datavisFriendly/status/1365801123584565249"))
```
...
try(include_tweet("https://twitter.com/Emil_Hvitfeldt/status/1356468455101227009"))
```
## automation quote
```{r, echo=FALSE}

try(include_tweet("https://twitter.com/CodeWisdom/status/1358724807525871617"))
```
...
#try(include_tweet("https://twitter.com/ShamiraGelbman/status/1354424275583848450"))
```
...
try(include_tweet("https://twitter.com/SMasonGarrison/status/1372640164493856773"))
```
